...
def main():
    # data_path = '/workspace/JuneLi/bbtv/SensedealImgAlg/WORKFLOW/DET/SealDet/v0/test_out/my_imgs_0/'
    data_path = '/workspace/JuneLi/bbtv/SensedealImgAlg/WORKFLOW/DET/SealDet/v2/test_out/my_imgs_0/'

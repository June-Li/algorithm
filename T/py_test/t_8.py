...
# import re
#
# # page_url = 'https://image.baidu.com/search/index?tn=baiduimage&ipn=r&ct=201326592&cl=2&lm=-1&st=-1&fm=result&fr=&sf=1&fmq=1620294053495_R&pv=&ic=&nc=1&z=&hd=&latest=&copyright=&se=1&showtab=0&fb=0&width=&height=&face=0&istype=2&ie=utf-8&sid=&word=%E7%AB%A0%E7%A8%8B%E7%9B%96%E7%AB%A0'
...
def download(imglist, num):
    ...
    ele1 = b.find_element_by_xpath('//*[@id="imgid"]/div[1]/ul/li[2]/div/a/img')
    ele1.click()

...
class Page(Container):
    ...
    def find_cell(self,cell_settings={}):
        return TableFinder(self,cell_settings).cells
    def find_edges(self,edge_settings={}):
        return TableFinder(self, edge_settings).edges

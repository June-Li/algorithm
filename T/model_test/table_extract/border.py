...
def border(table, image):
    ...
    ## to visualize the detected text areas
    # cv2.imwrite('./result/out_0/b.jpg', imag)
...
base_path = '/Volumes/my_disk/company/sensedeal/217_PycharmProject/bbtv/PaddleOCR-1.0-2021/doc/my_imgs_11/36.jpg'
image = cv2.imread(base_path)
img_h, img_w, _ = np.shape(image)
border([0, 0, img_w, img_h], image)
#

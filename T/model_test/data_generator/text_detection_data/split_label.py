...
path = '/home/sxs/djy/ctpn_data/pdf/new/'
gt_path = '/home/sxs/djy/ctpn_data/pdf/new/'
out_path = '/home/sxs/djy/ctpn_data/pdf/re_image'
...
for file in files:
    ...
    for line in lines:
        ...
        pt_y[1, 0] = int(float(splitted_line[1]) / img_size[0] * re_size[0])
        pt_x[2, 0] = int(float(splitted_line[2]) / img_size[1] * re_size[1])
        pt_y[2, 0] = int(float(splitted_line[3]) / img_size[0] * re_size[0])
        pt_x[3, 0] = int(float(splitted_line[0]) / img_size[1] * re_size[1])
        pt_y[3, 0] = int(float(splitted_line[3]) / img_size[0] * re_size[0])
        ...
        if not os.path.exists('/home/sxs/djy/ctpn_data/pdf/label_tmp'):
            os.makedirs('/home/sxs/djy/ctpn_data/pdf/label_tmp')
        with open(os.path.join('/home/sxs/djy/ctpn_data/pdf/label_tmp', stem) + '.txt', 'a') as f:

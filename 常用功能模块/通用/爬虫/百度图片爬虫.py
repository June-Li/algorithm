"""
视频教程地址：https://www.bilibili.com/video/BV1Va4y1Y7fK/?spm_id_from=autoNext
GitHub地址：https://github.com/unicorn-zxp/python_crawler
"""
...
def download(imglist, num):
    ...
    for i in range(1, num + 1):
        ...
        if r.status_code == 200:
            path = '/Volumes/my_disk/company/sensedeal/dataset/印章/crawl/百度-发票盖章/baidu_fapiao_%d.jpg' % x
            print('正在爬取  ' + img)
